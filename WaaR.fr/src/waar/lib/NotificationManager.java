...
public class NotificationManager {
	...
	public static void init_notifications(Context c)
	{
		...
		notifications.add(new WaarNotification("JdB", 0, 42001, "Journal de Bord : %s nouvelle(s) entrée(s).", "/royaume.php"));
		notifications.add(new WaarNotification("News", 0, 42002, "News : %s nouvelle(s) news " + Params.WAAR_SITE_NAME + " !", "/news.php"));
		notifications.add(new WaarNotification("Ally", 0, 42003, "Alliance : %s nouveau(x) message(s) d'alliance", "/alliance.php"));
		notifications.add(new WaarNotification("MP", 0, 42004, "Messages Privés : %s nouveau(x) message(s)", "/messages.php"));
